...
public class CoinChange {
	...
	private long numberOfCombinations(int[] coins, int requiredChange, int numberOfAvailableCoins) {
		...
		if (lookup.containsKey(l1)) {
			...
			//we either take the coin and reduce the remaining change and continue with the same number of coins
			subProblem1 = numberOfCombinations(coins, requiredChange - lastPossibleCoinValue, numberOfAvailableCoins);
